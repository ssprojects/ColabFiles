...
l1 = torch.tensor(np.load("Data/synthetic/Beta/test_l.npy")).long()

s = torch.tensor(np.load("Data/synthetic/Beta/train_s.npy")).double()
s1 = torch.tensor(np.load("Data/synthetic/Beta/test_s.npy")).double()
...
f = open("Results/continuous/synthetic/Beta/Output_beta_em.txt", "w", encoding="'utf8'")
