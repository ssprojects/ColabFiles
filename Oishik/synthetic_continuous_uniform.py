...
l = torch.tensor(np.load("Data/synthetic/Uniform/train_l.npy")).long()
l1 = torch.tensor(np.load("Data/synthetic/Uniform/test_l.npy")).long()

s = torch.tensor(np.load("Data/synthetic/Uniform/train_s.npy")).double()
s1 = torch.tensor(np.load("Data/synthetic/Uniform/test_s.npy")).double()

k = torch.tensor(np.load("Data/synthetic/Uniform/k.npy")).long()
y_true = np.load("Data/synthetic/Uniform/test_y.npy")
...
f = open("Results/continuous/synthetic/Uniform/Output_uniform_likelihood.txt", "w", encoding="'utf8'")
