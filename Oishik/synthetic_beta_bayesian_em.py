...
l = torch.tensor(np.load("Data/synthetic/Beta/train_l.npy")).long()
l_test = torch.tensor(np.load("Data/synthetic/Beta/test_l.npy")).long()

s = torch.tensor(np.load("Data/synthetic/Beta/train_s.npy")).double()
s_test = torch.tensor(np.load("Data/synthetic/Beta/test_s.npy")).double()

k = torch.tensor(np.load("Data/synthetic/Beta/k.npy")).long()
y_true = np.load("Data/synthetic/Beta/test_y.npy")
...
f = open("Results/continuous/synthetic/Beta_Bayesian/Output_beta_em.txt", "w", encoding="'utf8'")
...
for epoch in range(100):
    ...
    if supervised:
        ...
        p, r, f1_s, _ = precision_recall_fscore_support(y_true, y_pred, average='micro')
...
plt.savefig('Results/continuous/synthetic/Beta_bayesian/loss/loss_beta_em.png')
plt.close()
...
plt.legend(loc='best', frameon=False)
plt.savefig('Results/continuous/synthetic/Beta_bayesian/F1/F1_beta_em.png')